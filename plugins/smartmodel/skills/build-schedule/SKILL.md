---
name: build-schedule
description: Create or rebuild financial supporting schedules in a SmartModel workbook — revenue builds, COGS schedules, opex schedules, headcount plans, debt schedules. Use when a user asks to "build a schedule", "create a revenue build", "make a COGS schedule", "build out the debt schedule", "build a headcount plan", or needs a detailed supporting schedule for any P&L area. Also triggers on "revenue build", "expense build", "payroll tab", or "depreciation table".
---
